...
class ChessModel:
    ...
    def fit(self, dataset, y=None, validation_data=None, batch_size=None, epochs=10,
            shuffle=True, val_split=None,steps_per_epoch = None,validation_steps = None, callbacks=None):
        self.model.fit(x=dataset, y=y, batch_size=batch_size, epochs=epochs,
                       shuffle=True, validation_split=val_split,
                       validation_data=validation_data,steps_per_epoch = steps_per_epoch,validation_steps = validation_steps, 
                       callbacks=callbacks)
        return self.model
